...
# Висновки: ми навчилися налаштовувати середовище роботи VS Code, створили репозиторій Github та налаштували інтеграцію з ним, написали першу програму на Python та створили звіт з використанням форматування Markdown.
